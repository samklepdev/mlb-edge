...
| Phase 3 — projections (total_bases + strikeouts) | ✅ |
...
| `npm run backtest` | model-calibration report (ECE + Brier + reliability) |
...
| `npm run settle -- --date <d>` | grade picks vs actual TB/SO |
...
npm run backtest                          # compare ECE to the v0.1 baseline (0.091)
```
