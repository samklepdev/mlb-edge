    ...
    <main className="wrap wide">
      <header className="masthead">
        <h1 className="wordmark">
          <Link href="/">mlb-edge</Link> <span>/ props</span>
        </h1>
        <p className="purpose">
          One player, one prop, game by game against the market line. This is a
          research view, not a tip sheet — nothing here is scored as a win.
        </p>
      </header>
